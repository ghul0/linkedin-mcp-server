...
| `search_jobs` | Search for jobs with keywords and location filters; optional `output_mode`/`output_path` saves under `~/.linkedin-mcp/exports` |
...
| `get_job_details` | Get detailed information about a specific job posting; optional `output_mode`/`output_path` saves under `~/.linkedin-mcp/exports` |
